...
-- Set layout En when leave InsertMode (Only Sway)
--
...
-- Set layout En when leave InsertMode (Only Hyprland)
vim.api.nvim_create_autocmd({'InsertLeave', 'VimEnter'}, {
  callback = function() os.execute("hyprctl switchxkblayout logitech-usb-keyboard 0") end,
})
